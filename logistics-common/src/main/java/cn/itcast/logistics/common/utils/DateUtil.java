...
public class DateUtil {
	 ...
	 * yyyy-MM-dd HH:mm:ss
	 **/
	private static final ThreadLocal<SimpleDateFormat> FMT_YMDHMS = ThreadLocal.withInitial(() -> new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"));
	/**
	 * yyyyMMddHHmmss
	 **/
	 ...
	 * 时间格式字符长度与时间格式的映射
	 **/
	public static final HashMap<Integer, SimpleDateFormat> FMT_LENGTH_MAP = new HashMap<Integer, SimpleDateFormat>() {{
